...
const LaunchpadHome = lazy(() => import('./pages/WifPad/LaunchpadHome'));
const QuickLaunch = lazy(() => import('./pages/WifPad/QuickLaunch'));
const DegenLaunch = lazy(() => import('./pages/WifPad/DegenLaunch'));
const CustomLaunch = lazy(() => import('./pages/WifPad/CustomLaunch'));
const MyLaunches = lazy(() => import('./pages/WifPad/MyLaunches'));
const TokenDetails = lazy(() => import('./pages/WifPad/TokenDetails'));
const TradeHome = lazy(() => import('./pages/WifTrade/TradeHome'));
const AdvancedTrade = lazy(() => import('./pages/WifTrade/AdvancedTrade'));
const P2PEscrow = lazy(() => import('./pages/WifTrade/P2PEscrow'));
const Leaderboards = lazy(() => import('./pages/WifTrade/Leaderboards'));
const WalletTracker = lazy(() => import('./pages/WifTrade/WalletTracker'));
const CopyTrading = lazy(() => import('./pages/WifTrade/CopyTrading'));
const PerpsHome = lazy(() => import('./pages/WifPerps/PerpsHome'));
const PerpMarket = lazy(() => import('./pages/WifPerps/PerpMarket'));
const MyPositions = lazy(() => import('./pages/WifPerps/MyPositions'));
const Feed = lazy(() => import('./pages/WifSocial/Feed'));
const Profile = lazy(() => import('./pages/WifSocial/Profile'));
const Chats = lazy(() => import('./pages/WifSocial/Chats'));
const ChatRoom = lazy(() => import('./pages/WifSocial/ChatRoom'));
const Communities = lazy(() => import('./pages/WifSocial/Communities'));
